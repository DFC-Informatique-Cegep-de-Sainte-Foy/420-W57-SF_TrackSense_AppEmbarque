...
public:
    ...
    /*datas Posture fusionne avec acce et gyro*/
    struct TSPropertiesPosture
    {
        float RollAngle;  // PositionRoulis
        float PitchAngle; // PositionTangage
        float YawAngle;   // PositionLacet
        bool isChute;
    } PropertiesPosture;
